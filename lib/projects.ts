...
export const projects: Project[] = [
  ...
  {
    slug: "sbd-helene",
    title: "SBD — video med Helene",
    year: "2026",
    tag: "film",
    image: "/projects/sbd-helene.webp",
    gradient: "linear-gradient(135deg, #d999ff 0%, #7a3cff 55%, #160a2e 100%)",
  },
  {
    slug: "sporty-onboarding",
    title: "Sporty Onboarding",
    year: "2026",
    tag: "instruksjonsvideo",
    image: "/projects/sporty-onboarding.webp",
    gradient: "linear-gradient(135deg, #9be7d8 0%, #2f8f9e 55%, #0a1f24 100%)",
  },
  {
    slug: "gt-challenge",
    title: "GT Challenge",
